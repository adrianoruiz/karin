...
<template>
  <div
    v-if="show"
    class="fixed top-4 right-4 flex items-center w-full max-w-xs p-4 mb-4 bg-white rounded-lg shadow overflow-all"
    role="alert"
  >
    <div
    ...
    <div class="ml-3 text-sm font-normal" :class="textColors[type]">
      {{ message }}
    </div>
    <button
      @click="emit('close')"
