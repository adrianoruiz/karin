    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div class="space-y-4 text-center lg:text-left">
          ...
          <span class="block text-[#435B87] text-2xl font-sans mt-2 not-italic">CRM SC 26419</span>
          ...
          <a href="https://api.whatsapp.com/send?phone=5547991259577&text=Ol%C3%A1,%20gostaria%20de%20agendar%20uma%20consulta"
            target="_blank"
            class="inline-flex items-center mt-6 bg-[#7B736C] text-white px-10 py-3 rounded-full text-lg hover:bg-[#635C57] transition-colors">
