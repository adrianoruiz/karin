    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
        ...
        <div class="text-white">
          <h2 class="text-xl mb-4">Endereço</h2>
        ...
        <div class="text-white">
          ...
          <a href="https://api.whatsapp.com/send?phone=5547991259577&text=Ol%C3%A1,%20gostaria%20de%20agendar%20uma%20consulta" class="inline-flex items-center bg-white text-[#B7AC9F] px-4 py-2 rounded-full hover:bg-opacity-90 transition-colors">
