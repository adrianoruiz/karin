...
<template>
  <section id="consulta" class="relative py-20 bg-cover bg-center bg-no-repeat mobile-bg-adjust"
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
      <h2 class="text-4xl font-serif text-white mb-12">Consulta Online</h2>

      <div class="max-w-4xl space-y-12 mx-auto lg:mx-0">
        <div>
        ...
        <div class="pt-4">
          <a href="https://api.whatsapp.com/send?phone=5547991259577&text=Ol%C3%A1,%20gostaria%20de%20agendar%20uma%20consulta"
            target="_blank"
            class="inline-flex items-center px-8 py-3 border border-transparent text-lg font-medium rounded-full text-white bg-[#8B8379] hover:bg-[#8B8379]/90 transition-colors shadow-lg">
