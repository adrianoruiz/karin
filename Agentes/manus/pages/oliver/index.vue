  ...
  <div class="min-h-screen bg-gray-100">
    ...
    <div class="container mx-auto py-6 px-4">
      ...
      <div class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <div v-else class="space-y-3">
          <div v-for="task in tasksToday" :key="task.id" class="border-b pb-3 last:border-b-0 last:pb-0">
            <div class="flex items-center">
              <input type="checkbox" :checked="task.status === 'Concluída'" class="mr-3 h-5 w-5 text-blue-500"
        ...
        <button class="mt-4 bg-blue-500 text-white py-2 px-4 rounded" @click="showNewTaskModal = true">
          Nova Tarefa
        </button>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <button :disabled="generatingAnalysis" class="mt-4 bg-green-500 text-white py-2 px-4 rounded"
