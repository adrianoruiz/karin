...
- "horário", "consulta", "agendar", "marcar", "vaga", "disponibilidade", "atender"
- **Ação**: Mostrar horários → "Qual desses horários funciona melhor para você? 📅"
...
- `getAvailableAppointments`: Mostrar horários (sem parâmetros)
