...
class StoreReminderRequest extends FormRequest
{
    ...
    {
        // Apenas usuários autenticados podem criar lembretes
    ...
    public function messages(): array
    {
        return [
            ...
            'message.required' => 'A mensagem do lembrete é obrigatória.',
            ...
            'remind_at.required' => 'A data/hora do lembrete é obrigatória.',
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            // Verifica se pelo menos um destinatário foi especificado
            $hasRecipients = $this->has('recipient_ids') && !empty($this->recipient_ids);
            $hasAllPatients = $this->boolean('send_to_all_patients');
            $hasEmployees = $this->boolean('send_to_employees');

            if (!$hasRecipients && !$hasAllPatients && !$hasEmployees) {
                $validator->errors()->add('recipients', 'Pelo menos um destinatário deve ser especificado.');
            }
