...
class StoreCompleteUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'user_data.gender' => 'nullable|string|in:male,female,other',
            'user_data.marital_status' => 'nullable|string|max:50',
            'user_data.emergency_contact' => 'nullable|string|max:255',
            'user_data.emergency_contact_phone' => 'nullable|string|max:20',
            'user_data.alternative_phone' => 'nullable|string|max:20',
            ...
            'user_data.crm' => 'nullable|string|max:50',
            'user_data.rqe' => 'nullable|string|max:50',
