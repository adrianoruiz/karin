<template>
  <div class="bg-primary-700">
    ...
    >
      ...
      >
        <span class="block">Otimize sua clínica hoje mesmo</span>
        <span class="block text-primary-200">Junte-se a centenas de profissionais de saúde que transformaram seu atendimento.</span>
      </h2>
